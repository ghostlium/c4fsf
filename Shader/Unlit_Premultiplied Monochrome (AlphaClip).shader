...
//
///////////////////////////////////////////
Shader "Unlit/Premultiplied Monochrome (AlphaClip)" {
Properties {
...
void main()
{
    ...
    u_xlat16_1 = dot(u_xlat10_0.xyz, vec3(0.212599993, 0.715200007, 0.0722000003));
    u_xlat16_0 = vec4(u_xlat16_1) * vs_COLOR0;
    u_xlat2 = max(abs(vs_TEXCOORD1.y), abs(vs_TEXCOORD1.x));
    u_xlat2 = (-u_xlat2) + 1.0;
    u_xlatb2 = u_xlat2<0.0;
    SV_Target0 = (bool(u_xlatb2)) ? vec4(0.0, 0.0, 0.0, 0.0) : u_xlat16_0;
    return;
}
