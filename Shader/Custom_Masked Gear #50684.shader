...
//
///////////////////////////////////////////
Shader "Custom/Masked Gear" {
Properties {
_MainTex ("Base (RGB)", 2D) = "white" { }
_MaskTex ("Mask (A)", 2D) = "white" { }
_MaskColor ("Mask Color (RGBA)", Color) = (1,1,1,1)
...
void main()
{
    ...
    u_xlat16_2 = (-u_xlat16_1) + _MaskColor;
    u_xlat16_0 = vec4(u_xlat10_0) * u_xlat16_2 + u_xlat16_1;
    SV_Target0 = u_xlat16_0 * _TintColor;
    return;
}
