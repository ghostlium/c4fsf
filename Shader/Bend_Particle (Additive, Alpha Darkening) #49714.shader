...
//
///////////////////////////////////////////
Shader "Bend/Particle (Additive, Alpha Darkening)" {
Properties {
_MainTex ("Base (RGB)", 2D) = "white" { }
_TintColor ("Tint Color (RGB, A reduces background)", Color) = (1,1,1,1)
...
void main()
{
    u_xlat0.xyz = _TintColor.xyz * vec3(_ColorMultiplier);
    u_xlat10_1 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_1 = u_xlat10_1 * vs_COLOR0;
    u_xlat0.xyz = u_xlat0.xyz * u_xlat16_1.xyz;
    SV_Target0.w = u_xlat16_1.w * _TintColor.w;
...
CustomEditor "BendDisablerMaterialInspector"
}