...
//
///////////////////////////////////////////
Shader "Bend/Dissolve (Antagonist)" {
Properties {
...
void main()
{
    ...
    u_xlat16_1.x = u_xlat10_0.x + 0.150000006;
    u_xlat0 = u_xlat10_0.x + (-_DissolveThreshold);
    u_xlat0 = u_xlat0 * 20.0;
    u_xlat0 = clamp(u_xlat0, 0.0, 1.0);
    u_xlat0 = (-u_xlat0) + 1.0;
    SV_Target0.w = u_xlat0;
    u_xlat0 = u_xlat16_1.x + (-_DissolveThreshold);
    ...
    u_xlat16_2.xyz = (-u_xlat10_0.xyz) * _Color.xyz + _DissolveColor.xyz;
