...
//
///////////////////////////////////////////
Shader "Bend/Flag Improved (Background)" {
Properties {
...
void main()
{
    ...
    u_xlat2 = dot(in_POSITION0.xyz, vec3(1.0, 1.0, 1.0));
    u_xlat0.xyz = u_xlat0.xxx * _WaveWeights.xyz + vec3(u_xlat2);
    ...
    u_xlat0.xyz = u_xlat0.xyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    u_xlat6 = in_COLOR0.x * _WaveScale;
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat10_0.xyz * _Color.xyz + (-_BackgroundFogColor.xyz);
